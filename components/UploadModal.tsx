...
export const UploadModal: React.FC<UploadModalProps> = ({ onClose }) => {
  // useModalPresence(true); // Disable modal presence to prevent Mini Player from moving up
                                  ...
                                  <div className="px-4 pb-4 space-y-4">
                                    <div className="space-y-1.5">
                                      ...
                                      <div className="grid grid-cols-2 gap-3">
                                        <button
                                          type="button"
                                          onClick={() => setSongVisibility('public')}
                                          className={`w-full flex items-center justify-center gap-2 py-3 rounded-2xl border transition ${
                                            songVisibility === 'public' ? 'bg-white text-black border-white' : 'bg-black/40 text-zinc-300 border-white/5 hover:bg-black/30'
                                          }`}
                                        >
                                          <Icons.Globe size={16} />
                                          公开
                                        ...
                                        <button
                                          type="button"
                                          onClick={() => setSongVisibility('private')}
                                          className={`w-full flex items-center justify-center gap-2 py-3 rounded-2xl border transition ${
                                            songVisibility === 'private' ? 'bg-white text-black border-white' : 'bg-black/40 text-zinc-300 border-white/5 hover:bg-black/30'
                                          }`}
                                        >
                                          <Icons.Lock size={16} />
                                          私有
