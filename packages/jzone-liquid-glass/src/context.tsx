...
export function LiquidGlassCanvas({
  ...
  blurTapCap,
  cornerStyle,
  clockSdfSrc = '/liquid-glass-webgl/clock_sdf.webp',
  ...
  React.useEffect(() => {
    ...
    renderer.loadSdfTexture(clockSdfSrc).catch((e) => console.error(e))
