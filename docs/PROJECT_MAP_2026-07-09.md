...
- `npm run smoke:player-transition`：按 20/80/160/280/560/620/760ms 采样展开、按 20/80/180/320/400/460/620ms 采样收拢，验证裁剪边界、透明末段、文字等比矩阵、全屏落地回弹和 Mini 复位回弹；另连续快速反向 5 轮，检查方向无闪跳、Mini SVG 折射不中断、关闭后焦点恢复，并用不强制读取布局的独立探针记录帧预算。
