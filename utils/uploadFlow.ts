...
export const createUploadedSongFromRow = ({
  ...
  coverUrl,
  audioUrl: '',
  audioPath: row.stream_audio_path ?? row.audio_path,
  sourceAudioPath: row.audio_path,
  streamAudioPath: row.stream_audio_path ?? undefined,
  streamFileSize: typeof row.stream_file_size === 'number' ? row.stream_file_size : undefined,
  streamBitrateKbps: typeof row.stream_bitrate_kbps === 'number' ? row.stream_bitrate_kbps : undefined,
